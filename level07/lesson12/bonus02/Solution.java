...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        ArrayList<String> chdList = new ArrayList<String>();
    ...
    public static ArrayList<String> changedList(ArrayList<String> list, ArrayList<String> chdList){
        for (String str : list){
            String newStr;
            newStr = (str.length()%2==0) ? str+" "+ " "+str : str+" "+ " "+str+" "+str;
            chdList.add(newStr);
        }
        return chdList;
    }
